<%@ Page Title="" Language="C#" MasterPageFile="~/Shopping3.Master" AutoEventWireup="true" CodeBehind="Contactus.aspx.cs" Inherits="Shopping3.Contactus" %>
            ...
            <div class="row">
              <div class="col-xs-12 col-sm-6" id="contact_form_map">
                ...
                <ul class="store_info">
                  ...
                  <li><i class="fa fa-envelope"></i>Email: <span><a href="mailto:email@domain.com">support@themes.com</a></span></li>
                </ul>
              </div>
              <div class="col-sm-6">
